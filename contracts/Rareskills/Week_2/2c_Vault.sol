...
import "../Week_2/2a_ERC20_reward.sol";
import "../Week_2/2b_ERC721_nft.sol";
...
contract Vault is IERC721Receiver{
    ...
    bool public immutable partialPayment;
    ...
    constructor(address nftOwner, bool _partialPayment){
        owner = msg.sender;
        nft = new MyNFT(nftOwner);
        token = new RewardToken(address(this));
