...
contract VaultUpgradable is Initializable, IERC721ReceiverUpgradeable {
    //ownership
    ...
    function initialize(bool _partialPayment, address _myNft, address _token) public initializer {
        owner = msg.sender;
        nft = MyNFTUpgradable(_myNft);
        token = RewardTokenUpgradable(_token);
